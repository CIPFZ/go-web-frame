          ...
          return (
            <div
              ...
              style={{
                ...
                alignItems: 'center',
                border:
                  value === key ? '1px solid #1890ff' : '1px solid #f0f0f0',
                borderRadius: 4,
                fontSize: 22,
                // 图标稍大一点
        ...
        {currentIcons.length === 0 && (
          ...
          >
            <Empty
              ...
              description={t('cms.noMatchingIcons')}
            />
          </div>
        )}
      </div>
  ...
  return (
    ...
    >
      <Input
        value={value}
        readOnly
        placeholder={t('cms.chooseAnIcon')}
        prefix={
          value && allIcons[value] ? (
            React.createElement(allIcons[value])
          ) : (
            <SearchOutlined
              style={{
                color: '#bfbfbf',
