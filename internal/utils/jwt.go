...
func (j *JWT) ResolveToken(ctx context.Context, oldToken string, claims *request.CustomClaims) (string, *request.CustomClaims, error) {
	// 1. 如果没有过期，直接返回
...
func (j *JWT) createTokenByOldToken(ctx context.Context, oldToken string, claims request.CustomClaims) (string, error) {
