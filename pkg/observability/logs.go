...
func InitLogs(cfg Config) (*sdklog.LoggerProvider, ShutdownFunc, error) {
...
func createOtlpLogExporter(ctx context.Context, cfg OtelExporterConfig) (sdklog.Exporter, error) {
	if cfg.Endpoint == "" {
