...
func InitTraces(cfg Config) (ShutdownFunc, error) {
...
func createTracesExporter(cfg Config) (sdktrace.SpanExporter, error) {
	switch cfg.Exporter {
	case "stdout":
...
func createOtlpTraceExporter(ctx context.Context, cfg OtelExporterConfig) (sdktrace.SpanExporter, error) {
	if cfg.Endpoint == "" {
