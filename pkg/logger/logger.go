...
func NewLogger(cfg *Config, otelCfg *OTELLoggerConfig) (*zap.Logger, error) {
	// 解析日志级别
...
func NewOTELLogCore(otelCfg *OTELLoggerConfig, lvl zapcore.LevelEnabler) zapcore.Core {
	return &otelLogCore{
		levelEnabler: lvl,
